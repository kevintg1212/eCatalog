        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="icon-file-alt"></i> New Artikel</li>
            </ol>
          </div>
        </div><!-- /.row -->

        <div class="row">
            <form role="form" action="aksiNewBlog.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group" style="text-align:center">
                ...
                <input class="form-control" name="sortDesc" maxlength="280" type="text" onkeyup="textCounter(this,'counter',280);">
                <div class="none">
            ...
            <textarea id="summernote" class="form-control" name="longDesc"></textarea>
            <script>
