...
header("Location: banner.php");
  ...
  $vid =$_GET['id'];
  include 'koneksi.php';
  $data = mysqli_query($conn,"select * from banner where id_banner = $vid");
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="blog.php"><i class="icon-file-alt"></i> Banner</a></li>
              <li class="active"><i class="icon-file-alt"></i> Edit Banner</li>
            </ol>
          </div>
        </div><!-- /.row -->

        <div class="row">
            <form role="form" action="aksiEdBanner.php" method="post" enctype="multipart/form-data">
              ...
              <img class="img-thumbnail" style="width:300px;" id="blah" src="File/banner/<?php echo $d['file']; ?>" alt="your image"/>
                <input type="text" name="id_b" value="<?php echo $d['id_banner']; ?>" class="hidden-lg">
