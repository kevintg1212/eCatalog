...
<body class="animsition">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 col-lg-9 p-b-75">
					...
					<?php
					include 'admin/koneksi.php';
					$data = mysqli_query($conn,"select id_blog,YEAR(vdate),MONTHNAME(vdate),DATE(vdate),judul_artikel,vsort,file from blog");

					while($d = mysqli_fetch_array($data)){
					?>

						<!-- item blog -->
						<div class="item-blog p-b-80 p-t-30 p-l-20 p-r-20 filterDiv2 <?php echo $d['YEAR(vdate)'] ?> <?php echo $d['MONTHNAME(vdate)'] ?>">
							<a href="blog-detail.php?id=<?php echo $d['id_blog'] ?>" class="item-blog-img pos-relative dis-block hov-img-zoom">
									<div class="hov-img-zoom pos-relative">
										<img src="images/<?php echo $d['file']?>" alt="IMG-BLOG">
									</div>
									<div class="KiBa2">
										<h2><b><?php echo $d['judul_artikel']?></b></h2>
							...
							<div class="item-blog-txt p-t-33">
								...
								<a href="blog-detail.php?id=<?php echo $d['id_blog'] ?>" class="s-text20">
									Read More
	...
	<!--===============================================================================================-->
		...
		<?php
			include 'admin/koneksi.php';
			$data = mysqli_query($conn,"select id_blog,YEAR(vdate),MONTHNAME(vdate),DATE(vdate),judul_artikel,vsort,file from blog ORDER BY id_blog DESC limit 1");
